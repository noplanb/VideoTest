...
public class Config {
	...
	public static File getHomeDir() {
		...
		File dir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES),"videotest");
		if (!dir.exists()) {
			if (!dir.mkdirs()) {
	...
	public static File recordedFile() {
		return new File(recordedFilePath());
	}
